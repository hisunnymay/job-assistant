...
const mockAnalysisContent = `# 候选人与 AI 产品经理岗位的证据匹配报告

## 分析摘要

候选人的简历为 AI 产品设计、LLM 测试评估和复杂 B 端流程提供了明确证据；技术协作能力有部分证据；量化业务结果仍缺少可核验信息。
...
const mockResponse: MatchingAnalysisResponse = {
